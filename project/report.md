# Reports
**Table of Content**
- [Backup Executive Summary](#backup-executive-summaryBackup Executive Summary)
- [Job Status Summary](#job-status-summaryJob Status Summary)
- [Job Summary](#job-summaryJob Summary)
- [Job Volume Summary](#job-volume-summaryJob Volume Summary)
- [Job Type Count](#job-type-countJob Type Count)
- [Job Error Code](#job-error-codeJob Error Code)
- [Job Duration](#job-durationJob Duration)
- [Error Log Summary by Server](#error-log-summary-by-serverError Log Summary by Server)
- [Error Log Summary](#error-log-summaryError Log Summary)
- [Error Log Summary by Policy](#error-log-summary-by-policyError Log Summary by Policy)
- [Consecutive Errors](#consecutive-errorsConsecutive Errors)
- [Largest Backup Volume](#largest-backup-volumeLargest Backup Volume)
- [Monthly Backup Summary](#monthly-backup-summaryMonthly Backup Summary)
- [Job Summary by Server](#job-summary-by-serverJob Summary by Server)
- [Running and Queued Job Summary](#running-and-queued-job-summaryRunning and Queued Job Summary)
- [HP DP Session Summary](#hp-dp-session-summaryHP DP Session Summary)
- [Data Domain Backup Summary](#data-domain-backup-summaryData Domain Backup Summary)
- [NetBackup SLP Status](#netbackup-slp-statusNetBackup SLP Status)
- [Data Domain File Compression Summary](#data-domain-file-compression-summaryData Domain File Compression Summary)
- [Data Domain File Compression Detail](#data-domain-file-compression-detailData Domain File Compression Detail)
- [AWS EC2 Snapshot](#aws-ec2-snapshotAWS EC2 Snapshot)
- [AWS EC2 Snapshot Detail](#aws-ec2-snapshot-detailAWS EC2 Snapshot Detail)
- [Job Summary By Source](#job-summary-by-sourceJob Summary By Source)
- [Job Duration By Source](#job-duration-by-sourceJob Duration By Source)
- [Primary Server Job Throughput](#primary-server-job-throughputPrimary Server Job Throughput)
- [NetBackup Media Server Job Throughput](#netbackup-media-server-job-throughputNetBackup Media Server Job Throughput)
- [Source Backup Count Summary](#source-backup-count-summarySource Backup Count Summary)
- [NetBackup SLP Status by SLP](#netbackup-slp-status-by-slpNetBackup SLP Status by SLP)
- [NBU AIR Replication Import Jobs](#nbu-air-replication-import-jobsNBU AIR Replication Import Jobs)
- [NetBackup Deduplication to MSDP Savings - By Clients](#netbackup-deduplication-to-msdp-savings---by-clientsNetBackup Deduplication to MSDP Savings - By Clients)
- [NetBackup Deduplication to MSDP Savings - By Primary Servers](#netbackup-deduplication-to-msdp-savings---by-primary-serversNetBackup Deduplication to MSDP Savings - By Primary Servers)
- [NetBackup Deduplication to MSDP Savings - By Policy Type](#netbackup-deduplication-to-msdp-savings---by-policy-typeNetBackup Deduplication to MSDP Savings - By Policy Type)
- [NetBackup Deduplication to MSDP Savings Trend Over Time](#netbackup-deduplication-to-msdp-savings-trend-over-timeNetBackup Deduplication to MSDP Savings Trend Over Time)
- [Job Throughput by Client](#job-throughput-by-clientJob Throughput by Client)
- [Anomalies Summary](#anomalies-summaryAnomalies Summary)
- [NetBackup SLP Status by Client](#netbackup-slp-status-by-clientNetBackup SLP Status by Client)
- [NetBackup SLP Status by Image Copy](#netbackup-slp-status-by-image-copyNetBackup SLP Status by Image Copy)
- [Job Status Summary by Client](#job-status-summary-by-clientJob Status Summary by Client)
- [Ransomware Risk Assessment Dashboard](#ransomware-risk-assessment-dashboardRansomware Risk Assessment Dashboard)
- [Operations Dashboard](#operations-dashboardOperations Dashboard)
- [Alerts Dashboard](#alerts-dashboardAlerts Dashboard)
- [Storage Optimization Dashboard](#storage-optimization-dashboardStorage Optimization Dashboard)
- [Backup Server Performance Dashboard](#backup-server-performance-dashboardBackup Server Performance Dashboard)
- [NetBackup Deduplication to MSDP Savings Dashboard ](#netbackup-deduplication-to-msdp-savings-dashboard-NetBackup Deduplication to MSDP Savings Dashboard )
- [Azure Cloud Cost Spend Dashboard](#azure-cloud-cost-spend-dashboardAzure Cloud Cost Spend Dashboard)
- [Command Center Dashboard](#command-center-dashboardCommand Center Dashboard)
- [Data Protection Dashboard](#data-protection-dashboardData Protection Dashboard)
- [Mission Control - Backup](#mission-control---backupMission Control - Backup)
- [IBM Spectrum Protect (TSM) Storage Pools Dashboard](#ibm-spectrum-protect-tsm-storage-pools-dashboardIBM Spectrum Protect (TSM) Storage Pools Dashboard)
- [Job Histogram](#job-histogramJob Histogram)
- [NetBackup Audit Report](#netbackup-audit-reportNetBackup Audit Report)
- [NetBackup Event Notification Summary - CRITICAL](#netbackup-event-notification-summary---criticalNetBackup Event Notification Summary - CRITICAL)
- [Avamar Grid Capacity Dashboard](#avamar-grid-capacity-dashboardAvamar Grid Capacity Dashboard)
- [Data Domain Replication History](#data-domain-replication-historyData Domain Replication History)
- [Data Domain Snapshot History](#data-domain-snapshot-historyData Domain Snapshot History)
